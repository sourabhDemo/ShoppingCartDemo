function item(key, name, description, price, quantity, w, kf, s, d, ii) {
    this.sku = key;
    this.name = name;
...
CartService.prototype.addItem = function (sku, name, price, quantity) {
...
CartService.prototype.getTotalPrice = function (sku) {
    var total = 0;
...
CartService.prototype.addCheckoutParameters = function (serviceName, merchantID, options) {
...
// check out
CartService.prototype.checkout = function (serviceName, clearCart) {
...
CartService.prototype.checkoutPayPal = function (parms, clearCart) {
